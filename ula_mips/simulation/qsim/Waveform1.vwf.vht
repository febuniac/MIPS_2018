...
-- *****************************************************************************
-- Generated on "10/23/2018 14:36:35"
...
-- ula_ctrl[3]
t_prcs_ula_ctrl_3: PROCESS
BEGIN
	ula_ctrl(3) <= '0';
WAIT;
END PROCESS t_prcs_ula_ctrl_3;
-- ula_ctrl[2]
t_prcs_ula_ctrl_2: PROCESS
BEGIN
	ula_ctrl(2) <= '1';
WAIT;
END PROCESS t_prcs_ula_ctrl_2;
-- ula_ctrl[1]
t_prcs_ula_ctrl_1: PROCESS
BEGIN
	ula_ctrl(1) <= '1';
WAIT;
END PROCESS t_prcs_ula_ctrl_1;
-- ula_ctrl[0]
t_prcs_ula_ctrl_0: PROCESS
BEGIN
	ula_ctrl(0) <= '1';
WAIT;
END PROCESS t_prcs_ula_ctrl_0;
END ula_mips_arch;
